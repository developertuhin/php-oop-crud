...
<div class="container">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form action="" method="POST" class="form" enctype="multipart/form-data">
						...
						<div class="form-group">
							<input class="btn btn-success" type="submit" value="Save Data" id="submit-button"
								name="save-button">
	...
	<table class="table bg-light p-5">
		...
		<tr>
			...
			<td><img src="upload/<?php echo $value['image'] ?>" alt="" height="70px"
					style="width:70px; border-radius: 50%;"></td>
			<td>
				<a href="edit.php?status=edit&&id=<?php echo $value['id'] ?>" class="btn btn-info">EDIT</a>

				<a href="?status=delete&&id=<?php echo $value['id'] ?>" class="btn btn-danger"
